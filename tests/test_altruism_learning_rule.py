...
def test_altruism_learning_participant_only_direction_rules() -> None:
    ...
    Rules:
    - participating + positive satisfaction signal => altruism_factor increases
    - participating + negative satisfaction signal => altruism_factor decreases
    ...
    a.apply_altruism_update(satisfaction_signal=+1.0)
